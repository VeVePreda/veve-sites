...
export async function POST(context) {
  ...
  if (!email) return context.redirect('/connexion/?e=1', 303);
  ...
  if (!vr.ok) {
    ...
    return context.redirect('/connexion/?envoye=1', 303);
  }
  ...
  try {
    ...
    if (!r.ok) {
      ...
      if (r.status === 400) return context.redirect('/connexion/?e=1', 303);
      return context.redirect('/connexion/?e=2', 303);
    }
  } catch (e) {
